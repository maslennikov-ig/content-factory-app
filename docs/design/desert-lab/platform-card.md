...
Этот отдельный обзор начат: все девятнадцать поверхностей со знаком, их размеры,
назначение ссылок и четыре просчитанных пути для владельца перечислены в
[инвентаризации знака YouTube](youtube-mark-inventory.md)
