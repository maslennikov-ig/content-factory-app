...
evidence:
  - none
task_id: content-factory-next-fn33.55
...
success_criteria:
  - Радар зовёт туда, где источник действительно заводят
selected_docs:
...
docs_review_notes: Экран приводится к уже записанному решению карты.
verification:
...
Пустой радар звал «Добавьте источник» — вкладки источников в продукте нет с решения владельца (карта раздела, §3, §4). Текст называет два существующих места: подписку на вкладке «Откуда идеи» и факт прямо в брифе.
