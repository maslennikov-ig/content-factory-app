...
evidence:
  - none
task_id: content-factory-next-fn33.59
...
success_criteria:
  - Язык факта назван словом, а не кодом колонки
selected_docs:
...
docs_review_notes: Только подписи вариантов.
verification:
...
В списке «Язык» стояли сырые `ru` и `en`; теперь «Русский» и «English», каждое на своём языке. Значение на проводе не менялось.
