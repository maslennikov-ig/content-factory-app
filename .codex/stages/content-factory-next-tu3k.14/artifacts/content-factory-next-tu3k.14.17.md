...
task_id: content-factory-next-tu3k.14.17
...
## Owner feedback: button and labels

owner_copy / Luna max: 83dcd7e5 accepted by root as a09b5b4e. Secondary settings button and RU/EN back/automatic-format copy reviewed; diff check passed. Delivery: cherry-pick. Clean worktree and patch equivalence verified; worktree and branch removed. Remaining owner layout/search corrections and root release acceptance are pending.

Owner layout: 02d4e7ea accepted as 0e5f6f9b after diff review. Platform/channel overview, exact adaptation view, collapsed sources and friendly brief labels. Focused container 21/21; frontend tsc zero; diff check zero. Delivery accepted; worktree cleanup pending the final root flex-width/shared-button correction requested during owner consistency review.

Final width/style corrections: 85a2e0ca + 3da541cf accepted as 7e837750 + 3f918453. Root flex stretch and shared buttonClassName. Worker focused21/21, frontend tsc, diff check pass. All three source commits patch-equivalent; clean worktree and branch removed.
