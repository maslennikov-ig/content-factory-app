...
**RELEASED 25.09.2026 (hnov interface text through translation + ge2i notification emails in the recipient's language): `d37b3951a97f`, rollback `d305a7126e51`.** Private `5b04387eda11` on `release/2026-09-25-fourth` (= wave HEAD; `e395d0aee` now released); public `d37b395` (one trailer block); digest `sha256:4ef6e451…6dd02fe0`; Jest 518/7582, Node 126/0, Python 46 OK; four tsc clean; schema diff empty, env unchanged; backup `20260925T112543Z-pre-i18n-hnov-ge2i-product-only` (719); commands `--help` 0; nginx OK; healthy, 0 restarts; four addresses 200; archive byte-equal `b267fd57…`; fix in backend/orchestrator/frontend bundles; retention kept `d37b3951a97f` + `d305a7126e51`, disk 12G. Public CI green (Full suite needed one rerun: real-time `public-growth-event` throttle test). Guard `tests/interface-english.guard.test.cjs`. Evidence `evidence/release-2026-09-25-fourth.json`.
