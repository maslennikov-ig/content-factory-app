...
/**
 * Раздел «Помощь»: все его вопросы и то, что легко сделать неправильно.
 *
...
describe('текст раздела и документ говорят одно и то же', () => {
  test('в документе те же вопросы, что на экране, и в том же порядке', () => {
  ...
  test('английский набор — те же вопросы и ничего не пустует', () => {
...
describe('экран показывает все вопросы', () => {
