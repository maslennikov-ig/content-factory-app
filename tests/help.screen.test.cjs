...
/**
 * Раздел «Помощь»: шестнадцать вопросов и то, что легко сделать неправильно.
 *
...
describe('текст раздела и документ говорят одно и то же', () => {
  test('в документе ровно шестнадцать вопросов, и они в том же порядке', () => {
  ...
  test('английский набор — те же шестнадцать и ничего не пустует', () => {
...
describe('экран показывает все шестнадцать вопросов', () => {
