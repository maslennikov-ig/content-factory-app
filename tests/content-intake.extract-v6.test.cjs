...
// с `core-write/v14` (`97dq.97`) они английские для любого языка.
const { CORE_WRITE_BLOCK_TITLES_V14 } = loadWithMocks(
  'libraries/nestjs-libraries/src/content-intelligence/pieces/core-write-prompt.v14.ts'
);
