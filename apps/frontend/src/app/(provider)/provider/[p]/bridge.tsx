...
} from '@contentfactory/frontend/components/provider-preview/preview.provider.component';
import { ProviderPreviewSurface } from '@contentfactory/frontend/components/provider-preview/provider-preview.surface';
...
const ProviderPreviewBridge: FC<{ provider: string }> = ({
  ...
  if (!init) {
    return <ProviderPreviewSurface state="loading" provider={provider} />;
  }
