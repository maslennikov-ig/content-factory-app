...
export const voiceCopy = {
  ru: {
    ...
    analysisStageProposing: (done: number, total: number) =>
      `Собираем предложение: вызов ${Math.max(1, done)} из ${total}`,
    ...
    ribbonChoose: 'Выбрать аватар',
    ribbonWhatApplied: 'Аватар: что применено',
    ribbonHide: 'Свернуть',
  ...
  en: {
    ...
    analysisStageProposing: (done: number, total: number) =>
      `Drafting the proposal: call ${Math.max(1, done)} of ${total}`,
    ...
    ribbonChoose: 'Choose avatar',
    ribbonWhatApplied: 'Avatar: what applied',
    ribbonHide: 'Collapse',
