              ...
              {data.results.map((item: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && (
                      <div className="text-cf-accent-ink flex z-[10] justify-center items-center text-[14px] font-[500] w-[24px] h-[24px] rounded-full bg-cf-accent absolute -bottom-[2px] -end-[2px]">
