...
import { modeEmitter } from '@contentfactory/frontend/components/layout/mode.component';
...
const AppliedCouponDisplay: FC<{
  ...
  return (
    <div className="flex flex-col gap-[8px]">
      <div className="flex items-center gap-[12px] p-[16px] rounded-[12px] border border-cf-accent bg-cf-accent">
        <div className="flex-1">
          <div className="flex items-center gap-[8px] flex-wrap">
            ...
            <span className="font-[600] text-cf-signature">{appliedCode}</span>
            <span className="cf-body-md text-textColor/70">
        ...
        <Button
          ...
          disabled={isApplying}
          layout="content"
          className="px-0 hover:bg-transparent cf-body-md opacity-70 hover:opacity-100"
        >
    ...
    return (
      <div className="mt-[40px]">
        <Button
          ...
          layout="content"
          className="px-0 hover:bg-transparent text-[16px] font-[500] opacity-70 hover:opacity-100"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="18"
    ...
    <div className="mt-[40px]">
      ...
      <div className="flex gap-[12px]">
        ...
        <Button
          ...
          className="px-[24px] rounded-[8px] hover:opacity-90 transition-all"
        >
          {isApplying
...
const SubmitBar: FC<{ loading: boolean }> = ({ loading }) => {
  ...
  return (
    <div className="animate-fadeIn h-[92px] mobile:h-auto fixed bottom-0 w-full px-[12px] pb-[12px] left-0 bg-newBgColor z-[100]">
      <div className="w-full h-full border-t border-newColColor bg-newBgColorInner px-[80px] tablet:px-[33px] mobile:!px-[16px] flex mobile:flex-col gap-[32px] mobile:gap-[16px] justify-end items-center cf-body-md text-[#A3A3A3] mobile:py-[16px]">
        ...
        <div>
          <Button
            className="rounded-[10px] mobile:w-full"
            type="submit"
            loading={loading}
          >
            {checkout.checkout.recurring?.trial?.trialEnd
