...
import {
  productEventKeyFromIdentifier,
  useFireEvents,
} from '@contentfactory/helpers/utils/use.fire.events';
  ...
  const claim = useCallback(async () => {
    ...
    if (success) {
      ...
      try {
        ...
        await fireEvents('lifetime_claimed', { deduplicationKey });
      } catch {
