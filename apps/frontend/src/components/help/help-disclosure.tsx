 ...
 * копия. Второе — вот оно: первым была строка FAQ оплаты (`FAQSection`,
 * удалена вместе с FAQ в `2q28.8`). Здесь оно не переписано ещё раз, а
 * сделано так, чтобы извлечение в `@contentfactory/react` было переносом
 * файла: своей краски компонент не держит, геометрию строки берёт у `Button`,
 * а всё, что знает о помощи, приходит пропсами.
 *
