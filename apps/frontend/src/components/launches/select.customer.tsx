...
import { UserIcon, DropdownArrowIcon } from '@contentfactory/frontend/components/ui/icons';
import {
  MenuItem,
  Popover,
} from '@contentfactory/frontend/components/ui/layers';
    ...
    <div className="relative select-none z-[500]" ref={ref}>
      <div
        ...
        className={clsx(
          ...
          open ? 'border-cf-accent' : 'border-newColColor'
        )}
      >
        <div>
          <UserIcon />
      ...
      {open && (
        <div style={pos} className="fixed">
          <Popover className="flex flex-col min-w-[250px]">
            <div className="cf-label-md text-cf-ink px-[10px] py-[6px]">
