    ...
    <div className="text-cf-ink flex flex-wrap gap-[8px] items-center select-none">
      {!isListView && (
        <div className="flex flex-grow flex-wrap flex-row items-center gap-[8px]">
          <div className="border h-[40px] border-cf-border bg-cf-border gap-[1px] flex items-center rounded-[8px] overflow-hidden">
            <div
              onClick={previous}
              className="cursor-pointer text-cf-ink rtl:rotate-180 px-[9px] bg-cf-surface h-full flex items-center justify-center hover:text-cf-ink hover:bg-cf-surface-subtle"
            >
              <svg
            ...
            <div className="min-w-[200px] text-center bg-cf-surface h-full flex items-center justify-center">
          ...
          <div className="flex-1 text-[14px] font-[500]">
            <div className="text-center flex h-[40px]">
              <div
                onClick={setToday}
                className="hover:text-cf-ink hover:bg-cf-surface-subtle py-[3px] px-[9px] flex justify-center items-center rounded-[8px] transition-all cursor-pointer text-[14px] bg-cf-surface border border-cf-border-control"
              >
                {t('today', 'Today')}
              </div>
            </div>
        ...
        <div className="flex flex-grow flex-wrap flex-row items-center gap-[8px]">
          <div className="border h-[40px] border-cf-border bg-cf-border gap-[1px] flex items-center rounded-[8px] overflow-hidden">
            <div
              ...
              className={clsx(
                'text-cf-ink rtl:rotate-180 px-[9px] bg-cf-surface h-full flex items-center justify-center',
                calendar.listPage > 0
                  ? 'cursor-pointer hover:text-cf-ink hover:bg-cf-surface-subtle'
              ...
              <div
                ...
                className={clsx(
                  ...
                  calendar.listState === option.value &&
                    'text-cf-accent bg-cf-accent-soft'
                )}
              >
                {option.label}
              </div>
        ...
        <div className="flex flex-row p-[4px] border border-cf-border rounded-[8px] text-[14px] font-[500]">
          <div
            className={clsx(
              ...
              calendar.display === 'day' && 'text-cf-accent bg-cf-accent-soft'
            )}
            onClick={setDay}
          >
            {t('day', 'Day')}
          ...
          <div
            className={clsx(
              'pt-[6px] pb-[5px] cursor-pointer w-[74px] text-center rounded-[6px]',
              calendar.display === 'week' && 'text-cf-accent bg-cf-accent-soft'
            )}
            onClick={setWeek}
          >
            {t('week', 'Week')}
          ...
          <div
            className={clsx(
              'pt-[6px] pb-[5px] cursor-pointer w-[74px] text-center rounded-[6px]',
              calendar.display === 'month' && 'text-cf-accent bg-cf-accent-soft'
            )}
            onClick={setMonth}
          >
            {t('month', 'Month')}
      ...
      <div className="flex flex-row p-[4px] border border-cf-border rounded-[8px] text-[14px] font-[500]">
        <div
          ...
          className={clsx(
            ...
            !isListView && 'text-cf-accent bg-cf-accent-soft'
          )}
        >
          {/*calendar*/}
          <svg
