    ...
    <div className="flex flex-col gap-[16px]">
      <div className="flex flex-col gap-[6px]">
        ...
        <Textarea standalone
          ...
          className="bg-input p-[16px] outline-none border-fifth border rounded-[4px] text-inputText placeholder-inputText"
        />
      </div>
      <div className="flex flex-col gap-[6px]">
          ...
          {list.map((p) => (
            <div
              ...
              className={clsx(
                ...
                style === p
                  ? 'bg-cf-accent border-cf-accent text-cf-accent-ink'
