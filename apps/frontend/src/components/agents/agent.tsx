...
import { SVGLine } from '@contentfactory/frontend/components/launches/launches.component';
import { useFetch } from '@contentfactory/helpers/utils/custom.fetch';
import { useWaitForClass } from '@contentfactory/helpers/utils/use.wait.for.class';
            ...
            >
              ...
              >
                {(integration.inBetweenSteps || integration.refreshNeeded) && (
                  <div className="absolute start-0 top-0 w-[48px] h-[48px] cursor-pointer">
                ...
                {integration.picture ? (
                  <img
                    ...
                    onError={({ currentTarget }) => {
                      ...
                      currentTarget.src = `/icons/platforms/${integration.identifier}.png`;
                    }}
                  />
                ) : (
                  <PlatformSymbol
    ...
    >
      <div className="absolute top-0 start-0 w-full h-full px-[20px] pb-[20px] overflow-auto scrollbar scrollbar-thumb-fifth scrollbar-track-newBgColor">
        <OpeningBand className="justify-center group-[.sidebar]:pb-[15px]">
          <Link
            href={`/agents`}
            className="text-cf-accent-ink whitespace-nowrap flex-1 pt-[12px] pb-[14px] ps-[16px] pe-[20px] group-[.sidebar]:p-0 min-h-[44px] max-h-[44px] rounded-md bg-btnPrimary flex justify-center items-center gap-[5px] outline-none"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="21"
