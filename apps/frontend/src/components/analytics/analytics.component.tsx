...
import { StarsAndForks } from '@contentfactory/frontend/components/analytics/stars.and.forks';
import { FC, useCallback } from 'react';
import { StarsTableComponent } from '@contentfactory/frontend/components/analytics/stars.table.component';
