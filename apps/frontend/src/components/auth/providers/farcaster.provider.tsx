...
import { NeynarAuthButton } from '@contentfactory/frontend/components/auth/nayner.auth.button';
...
export const ButtonCaster: FC<{
  ...
  return (
    ...
    >
      <NeynarAuthButton onLogin={login} className={AUTH_PROVIDER_BUTTON_CLASS}>
        <svg
        ...
        <span className="truncate">{t('farcaster', 'Farcaster')}</span>
      </NeynarAuthButton>
    </NeynarContextProvider>
  );
};
