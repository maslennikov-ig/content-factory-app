 ...
 * плотной строке, 48 в форме, 72 в шапке профиля. Всё на ритме 4px.
 */
...
const SIZE_CLASS = {
  ...
  // Шапка профиля (`97dq.51`): лицо здесь — главный предмет, а не подпись
  // к строке, и буква набирается заголовочным токеном шкалы.
  72: 'size-[72px] cf-heading-lg',
} as const;
