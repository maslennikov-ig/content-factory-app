...
const ModeComponent = () => {
  ...
  return (
    <Button
      ...
      // The control is on a public page now, where the visitor's language is
      // whatever their browser asked for. An English tooltip on a Russian
      // landing page is the kind of seam that makes a product look borrowed.
      title={label}
      aria-label={label}
