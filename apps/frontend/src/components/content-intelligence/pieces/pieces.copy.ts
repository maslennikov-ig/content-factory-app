...
export const piecesCopy = {
  ru: {
    ...
    saveForChannelHint: 'Эти значения станут умолчаниями канала для новых постов.',
    ...
    rewriteAndRememberHint: 'Новый вариант, и эти значения станут умолчаниями канала.',
