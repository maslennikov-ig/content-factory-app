 ...
 *
 * Всё, что раньше делало окно «Создать пост», здесь в одну строку: дата,
 * взведённое «Удалить адаптацию» и главная кнопка «Запланировать» с
 * «Опубликовать сейчас» в её меню. Черновик правится и отправляется;
