 ...
 * чинили (`fn33.90.8`).
 *
 * **По словам отбирает только сервер.** Клиент сохраняет присланные
 * словоформы и выдержку; повторный поиск точной фразы отбрасывал находки
 * русского стеммера. Локальный фильтр состояния отделяет архивные строки.
 *
