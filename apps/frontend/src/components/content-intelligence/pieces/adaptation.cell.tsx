...
/**
 * Тон `Status` для состояния — тот же, что у клетки.
 *
 * Одна пара «слово · тон» на состояние (`97dq.39`, B3): до неё страница
 * заготовки держала свои тернарники в двух местах и назвала черновик
 * «готово», пока список рядом говорил «черновик».
 */
export const stateTone = (state: PieceCellStateV1): StatusTone =>
  TONE[state] ?? 'neutral';
